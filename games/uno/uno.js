...
class Card {
    ...
    toHTML() {
        var HTML = null,
            number = this.number;
        switch (this.number) {
            case "wild x4": HTML = `<div class="${this.class || 'card wild'}"><span class="num-small top">x4</span><span class="num-large" style="font-family:MSR">cards</span><span class="num-small bottom">x4</span></div>`
                break;
